    ...
    <div className="help-container">
      ...
      <div className="help-content">
        ...
        <div className="faq-section">
          ...
          <ul>
            <li><strong>كيف يمكنني الاشتراك في المواد الدراسية؟</strong> <br/>يمكنك الاشتراك في المواد الدراسية من خلال زيارة صفحة الفايسبوك و ارسال وصل الدفع ثم سيتم فتح جميع الدروس لك.</li>
            ...
            <li><strong>كيف يمكنني التواصل مع الدعم الفني؟</strong> <br/> يمكنك التواصل مع الدعم الفني من خلال إرسال رسالة إلى البريد الإلكتروني: bouhouch@walidacademy.com</li>
          </ul>
        </div>
        ...
        <div className="contact-section">
          ...
          <p><strong>البريد الإلكتروني:</strong> bouhouch@walidacademy.com</p>
          <p><strong>الهاتف:</strong> 29778011</p>
        </div>
